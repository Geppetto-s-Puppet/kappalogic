...
| `examples/` | 実行できるデモ12本(命題32の順序依存発火、v0.76のSP2線形スケーリングDFT、v0.77の量子測定、v0.78のBCS超伝導、v0.80の電子輸送、v0.81の磁性、v0.82の分岐分類デモを含む)+ 外付け実験3件(`kappa_cpu/`, `gauge_adder_chain/`, `cuda/`。下記「関連実験」参照) |
